...
This guide provides instructions for building, running, and testing the OctoCAT Supply Chain Management application, which consists of a FastAPI backend and a Vue.js frontend.
...
2. Install dependencies:
   ...
   cd api && python3 -m venv .venv && source .venv/bin/activate && pip install -e ".[dev]" && cd ..
