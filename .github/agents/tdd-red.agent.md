...
tools: ['edit', 'search', 'runCommands', 'runTasks', 'usages', 'problems', 'testFailure', 'githubRepo', 'todos', 'runSubagent', 'runTests']
handoffs:
...
Follow the codebase conventions (pytest style):

```python
import pytest
from src.path.to.module import function_to_test
...
- Add docstrings for test descriptions
