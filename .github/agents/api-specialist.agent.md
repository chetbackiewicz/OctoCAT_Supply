...
- **FastAPI Routes**: Proper request/response handling, validation, error propagation
...
2. **Code Quality Focus**
   ...
   - Type safety (proper type hints, Pydantic models)
...
- **Types**: Proper type hints throughout, Pydantic models for validation

## Reference Architecture

```
api/src/
├── models/          # Pydantic models matching schema
