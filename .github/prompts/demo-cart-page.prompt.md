---
agent: 'agent'
description: 'Add Cart Page and Icon with Vision and Agent Mode'
tools: ['runCommands', 'runTasks', 'edit/editFiles', 'search', 'usages', 'problems', 'changes', 'testFailure', 'openSimpleBrowser', 'fetch', 'githubRepo']
---

# Cart Page and Icon Implementation

## Context
You are working with the OctoCAT Supply Chain Management System - a modern web application with separate API (FastAPI/Python) and Frontend (Vue 3) projects.
...
4. **Cart Composable**: Custom composable for cart operations
