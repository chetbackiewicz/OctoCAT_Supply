...
tools: ['search', 'github-remote/assign_copilot_to_issue', 'github-remote/issue_read', 'github-remote/issue_write', 'github-remote/list_issues', 'github-remote/search_issues', 'usages', 'problems', 'openSimpleBrowser', 'fetch', 'githubRepo']
---

# Use Coding Agent to test multiple paths - in parallel!

## Context
This shows how to use the Coding Agent to test multiple paths in parallel, allowing you to explore different solutions and approaches quickly.
...
1. **Cart Store**: Create a Pinia store to manage cart state globally
2. **Cart Icon**: Add to Navigation component with item count badge
3. **Cart Composable**: Custom composable for cart operations
...
2. Create cart state management (Pinia store + composable)
